...
<body>
    ...
    Executa as declarações aninhadas repetidamente, enquanto a expressão do <b>while</b> forem avaliadas como true
    <?php
        $a = 1;
        while ($a <= 3) 
        {
        ...
        No DO WHILE, a expressão de avaliação é verificada ao final de cada iteração em vez de no começo como no WHILE.
    <?php
        $num = 1;
                do {
